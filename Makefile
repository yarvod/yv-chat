...
frontend-build:
	...
	test -s frontend/.output/public/crypto/v8/yv_chat_openmls_provider_bg.wasm
	grep -q 'crypto/v8/yv_chat_openmls_provider_bg.wasm' frontend/.output/public/sw.js
...
crypto-wasm-bindgen: crypto-wasm
	...
	grep -q 'signCallBinding(role: string' crypto/target/wasm-bindgen/yv_chat_openmls_provider.d.ts
	grep -q 'verifyCallBinding(role: string' crypto/target/wasm-bindgen/yv_chat_openmls_provider.d.ts
	grep -q 'callVerificationCode(conversation_id: string' crypto/target/wasm-bindgen/yv_chat_openmls_provider.d.ts
