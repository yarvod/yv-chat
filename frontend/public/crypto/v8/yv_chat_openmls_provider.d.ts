...
export class DeviceBootstrap {
    ...
    callVerificationCode(conversation_id: string, call_id: string, caller_user_id: string, caller_device_id: string, callee_user_id: string, callee_device_id: string, offer_sdp: string, offer_signature: Uint8Array, answer_sdp: string, answer_signature: Uint8Array): string;
    createConversation(conversation_id: string): bigint;
    credentialIdentity(): Uint8Array;
    fingerprint(): string;
    generateKeyPackages(count: number): Array<any>;
    inspectConversation(conversation_id: string): ConversationStateOutput | undefined;
    ...
    rejoinConversation(conversation_id: string, welcome: Uint8Array, ratchet_tree: Uint8Array): bigint;
    ...
    signCallBinding(role: string, conversation_id: string, call_id: string, caller_user_id: string, caller_device_id: string, callee_user_id: string, callee_device_id: string, sdp: string): Uint8Array;
    ...
    verifyCallBinding(role: string, conversation_id: string, call_id: string, caller_user_id: string, caller_device_id: string, callee_user_id: string, callee_device_id: string, sdp: string, signature: Uint8Array): void;
}
...
export interface InitOutput {
    ...
    readonly __wbg_conversationstateoutput_free: (a: number, b: number) => void;
    ...
    readonly conversationstateoutput_deviceIds: (a: number) => any;
    ...
    readonly devicebootstrap_callVerificationCode: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number, q: number, r: number, s: number, t: number, u: number) => [number, number, number, number];
    ...
    readonly devicebootstrap_inspectConversation: (a: number, b: number, c: number) => [number, number, number];
    ...
    readonly devicebootstrap_rejoinConversation: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [bigint, number, number];
    readonly devicebootstrap_signCallBinding: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number, q: number) => [number, number, number, number];
    ...
    readonly devicebootstrap_verifyCallBinding: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number, q: number, r: number, s: number) => [number, number];
    ...
    readonly conversationstateoutput_epoch: (a: number) => bigint;
