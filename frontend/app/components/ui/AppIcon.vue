...
<template>
  ...
  >
    <template v-if="name === 'chat'">
      <path d="M21 11.5a8.4 8.4 0 0 1-9 8.5 9.5 9.5 0 0 1-3.8-.8L3 21l1.7-4.6A8.4 8.4 0 1 1 21 11.5Z" />
      <path d="M8.2 11.8h.01M12 11.8h.01M15.8 11.8h.01" stroke-width="2.8" />
    </template>
